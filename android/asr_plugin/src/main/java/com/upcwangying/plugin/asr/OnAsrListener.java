...
public interface OnAsrListener {
     ...
     */
    void onAsrPartialResult(String[] results, AsrResult recogResult);
     ...
     * @param recogResult 完整的结果
     */
    void onAsrFinalResult(String[] results, AsrResult recogResult);

    /**
     * CALLBACK_EVENT_ASR_FINISH
     * @param recogResult 结束识别
     */
    void onAsrFinish(AsrResult recogResult);
